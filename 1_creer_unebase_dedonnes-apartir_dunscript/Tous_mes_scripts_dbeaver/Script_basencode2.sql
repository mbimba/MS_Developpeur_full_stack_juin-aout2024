...
--
-- Host: localhost    Database: basencode
-- ------------------------------------------------------
...
DROP DATABASE IF EXISTS basencode2;
CREATE DATABASE basencode2;
USE basencode2;
--
...
CREATE TABLE `employe` (
  ...
  PRIMARY KEY (`noemp`),
  KEY `nodep` (`nodep`),
  CONSTRAINT `employe_ibfk_1` FOREIGN KEY (`nodep`) REFERENCES `dept` (`nodept`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-06-17 11:41:32