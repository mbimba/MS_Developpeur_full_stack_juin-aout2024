    ...
    <main>
            ...
            <?php if ($show_categories): ?>
                            ...
                            echo '<div class="col-sm-4 p-3 bg-dark text-white zoomimage">
                                <div class="img-fluid">
                                    ...
                                    <a href="plats.php?id=' . htmlspecialchars($categorie['id']) . '">
                                        <img class="rounded-circle mx-auto d-block border border-black-1" src="images_the_district/category/' . htmlspecialchars($categorie['image']) . '" alt="' . htmlspecialchars($categorie['libelle']) . '">
                                    </a>
                                </div>
                            </div>';
                        }
                ...
                <div class="container-fluid mt-3 pt-5 card text-center w-75 bg-secondary">
                    <div class="row">
                        <?php
                        foreach ($categories_second_set as $categorie) {
                            echo '<div class="col-sm-4 p-3 bg-secondary text-white zoomimage">
                                <div class="img-fluid">
                                    <h2>' . htmlspecialchars($categorie['libelle']) . '</h2>
                                    <a href="plats.php?id=' . htmlspecialchars($categorie['id']) . '">
                                        <img class="rounded-circle mx-auto d-block border border-black-1" src="images_the_district/category/' . htmlspecialchars($categorie['image']) . '" alt="">
                                    </a>
                                </div>
                            </div>';
                        }
