...
// La fonction strpos peut retourner un nombre (position de la sous-chaîne) ou false (si la sous-chaîne n'est pas trouvée).
// En utilisant !== false, on vérifie que strpos a trouvé la sous-chaîne, car 0 est une position valide (début de la chaîne), tandis que false indique que la sous-chaîne n'a pas été trouvée. -->
            </li>
